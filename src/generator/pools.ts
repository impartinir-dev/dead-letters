...
export const FIRST_NAMES = [
  'ABEL', 'ALMA', 'ARCHIE', 'AUGUST', 'BEA', 'BERNARD', 'CASPER', 'CLIVE', 'CONRAD',
  'DASHIELL', 'DOROTHY', 'EDGAR', 'ELEANOR', 'ELLIOT', 'ESTHER', 'EUGENE', 'FAY',
  'GILBERT', 'GRETA', 'HAZEL', 'HORACE', 'INEZ', 'JASPER', 'JUNE', 'LAVINIA',
  'LIONEL', 'LUCILLE', 'MAGNUS', 'MINNIE', 'MURIEL', 'NED', 'OSCAR', 'PERCY',
  'PHOEBE', 'QUENTIN', 'REGINALD', 'ROSALIND', 'RUTH', 'SYLVIA', 'TABITHA',
  'ULYSSES', 'VIOLET', 'WINIFRED',
...
/**
 * ~225 surnames: 150 cases x 5 names each, and the generator caps every
 * surname at 4 appearances across the whole casebook. Avoid words that are
 * suspect roles, rooms, weapons or title keywords.
 */
export const SURNAMES = [
  'ABERNATHY', 'ACKLAND', 'AINSWORTH', 'ALCOTT', 'ALDRIDGE', 'ARKWRIGHT', 'ATHERTON',
  'AVERY', 'AXTELL', 'BALFOUR', 'BANNISTER', 'BARLOW', 'BEAUMONT', 'BELLAMY',
  'BENTLEY', 'BLAKE', 'BOSWELL', 'BRAMWELL', 'BRENNAN', 'BROMLEY', 'BURKE', 'BYRNE',
  'CALLOWAY', 'CARLISLE', 'CASWELL', 'CHANDLER', 'CLAYBORNE', 'COLBY', 'CORCORAN',
  'CORDELL', 'CROFT', 'CULLEN', 'DALTON', 'DARROW', 'DAVENPORT', 'DEVEREUX', 'DOYLE',
  'DRUMMOND', 'DUNMORE', 'DUVALL', 'EASTWOOD', 'ELLERY', 'ELLISON', 'EMBERLEY',
  'ENDICOTT', 'EVERETT', 'FAIRCLOUGH', 'FALCONER', 'FARRELL', 'FAULKNER', 'FELL',
  'FLETCHER', 'FORSYTHE', 'FROST', 'GALLAGHER', 'GARLAND', 'GILCHRIST', 'GODWIN',
  'GRANGER', 'GREAVES', 'GRIMSHAW', 'GRISWOLD', 'HADLEY', 'HALE', 'HARGROVE',
  'HASKELL', 'HATHAWAY', 'HAYWARD', 'HEATHCOTE', 'HOLLIS', 'HUXLEY', 'IRVING',
  'ISHERWOOD', 'IVES', 'JARVIS', 'JESSUP', 'JOLLIFFE', 'KEANE', 'KEMBLE', 'KENDRICK',
  'KILBRIDE', 'KINCAID', 'KIRKWOOD', 'KNOX', 'LACEY', 'LANGLEY', 'LARUE', 'LATIMER',
  'LAWLESS', 'LINLEY', 'LOWELL', 'LUDLOW', 'MADDOX', 'MALLORY', 'MARCHETTI',
  'MAXWELL', 'MCALLISTER', 'MERRICK', 'MONTAGUE', 'MORROW', 'MULLIGAN', 'NASH',
  'NEVILLE', 'NORCROSS', 'NORTHCOTT', 'OAKLEY', 'OGILVY', 'ORMSBY', 'OVERTON',
  'PARRISH', 'PEMBERTON', 'PENROSE', 'PERCIVAL', 'PRENTISS', 'PRESCOTT', 'PRICE',
  'QUAID', 'QUINCEY', 'RADCLIFFE', 'RAINES', 'REDFERN', 'REEVES', 'RENFREW',
  'RIORDAN', 'ROWE', 'RUTHERFORD', 'SAXBY', 'SEDGWICK', 'SELWYN', 'SHAW', 'SHELBY',
  'SLOANE', 'SPENCER', 'STANHOPE', 'STRAND', 'SUTCLIFFE', 'SWIFT', 'TALBOT',
  'TAVENER', 'TEMPLETON', 'THACKERAY', 'TREMAINE', 'TULLY', 'TURNBULL', 'UPTON',
  'URQUHART', 'VANCE', 'VANDERMEER', 'VAUGHN', 'VEREKER', 'WAINWRIGHT', 'WARWICK',
  'WEATHERBY', 'WENTWORTH', 'WESTCOTT', 'WINSLOW', 'WOLCOTT', 'WYATT', 'YARDLEY',
  'YATES', 'ZANE', 'ZIMMER',
  'ALBRIGHT', 'ASHBY', 'BRADDOCK', 'CAVENDISH', 'CONWAY', 'DEVLIN', 'DUNSTAN',
  'FAIRFAX', 'FINNEGAN', 'GALLOWAY', 'GRAYSON', 'HOLT', 'LANCASTER', 'MARLEY',
  'MERRIWEATHER', 'ORWELL', 'PAGET', 'PRUITT', 'RAWLINS', 'STOKES', 'SUTTON',
  'TREVELYAN', 'WHITAKER', 'WINTHROP',
